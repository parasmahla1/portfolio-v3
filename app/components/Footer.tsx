...
const socialData = [
  {
    link: 'https://github.com/parasmahla1/',
    icon: <Github width={iconSize.width} height={iconSize.height} />
  },
  {
    link: 'https://www.linkedin.com/in/parasmahla80/',
    icon: <Linkedin width={iconSize.width} height={iconSize.height} />
  },
  {
    link: 'https://leetcode.com/u/parasmahla80/',
    icon: <LeetCodeIcon width={iconSize.width} height={iconSize.height} />
  }
]
