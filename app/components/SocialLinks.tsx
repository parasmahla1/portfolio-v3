...
export const socialData = [
  { link: 'https://github.com/parasmahla1',icon: <Github /> },
  { link: 'https://www.linkedin.com/in/parasmahla80/', icon: <Linkedin /> },
  { link: 'https://leetcode.com/u/parasmahla80', icon: <LeetCodeIcon /> }
]
